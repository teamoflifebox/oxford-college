    ...
    <main className="pt-20">
      ...
      <section className="bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            {[
              "https://via.placeholder.com/1200x500?text=Collaborative+Space",
              "https://via.placeholder.com/1200x500?text=Prototyping+Lab",
              "https://via.placeholder.com/1200x500?text=Tech+Workshop",
              "https://via.placeholder.com/1200x500?text=Innovation+Team"
            ].map((src, idx) => (
              <SwiperSlide key={idx}>
                <img
                  src={src}
