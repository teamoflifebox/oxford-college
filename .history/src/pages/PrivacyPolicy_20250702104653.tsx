    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 mt-16 text-slate-700">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            Details submitted via our online forms (e.g., inquiries,
            registrations)
          </li>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            Send important updates, newsletters, or marketing communications
            (with your consent)
          </li>
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            Service providers who help us operate the website and deliver
            services
          </li>
          <li>
