    ...
    <main className="pt-20">
      ...
      <section className="bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            {[
              "https://images.unsplash.com/photo-1612837017391-18bba6231f3a?auto=format&fit=crop&w=1200&q=80",
    "https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=1200&q=80",
    "https://images.unsplash.com/photo-1629904853698-e4d1fd0f4ccf?auto=format&fit=crop&w=1200&q=80",
    "https://images.unsplash.com/photo-1581090700222-90aa9b67fc20?auto=format&fit=crop&w=1200&q=80"
            ].map((src, idx) => (
              <SwiperSlide key={idx}>
                <img
                  src={src}
