...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-screen">
            ...
            <div className="lg:col-span-5 space-y-8 animate-slideInLeft">
              ...
              {/* Quick Stats */}
              <div className="grid grid-scols-2 gap-6 pt-8 animate-fadeInUp" style={{animationDelay: '1s'}}>
                {[
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="text-center p-8 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-blue-600 font-medium">Tech Curriculum</span>
            </div>
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Cutting-Edge Courses</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {courses.map((course, index) => (
              <div key={index} className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:scale-105 transition-all duration-300 group">
                <div className="text-4xl mb-4">{course.icon}</div>
                ...
                <button 
                  className="w-full py-2 text-blue-600 border border-blue-200 rounded-xl hover:bg-blue-50 transition-colors"
                  onClick={() => handleLearnMore(course)}
                >
                  Learn More
                </button>
      ...
      {/* Placement Stats */}
      <section id="placements" className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 relative overflow-hidden">
        <div className="absolute inset-0 bg-black/10"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Tech Career Excellence</h2>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div key={currentTestimonial} className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-center">
              <div className="flex justify-center mb-4">
                {[...Array(testimonials[currentTestimonial].rating)].map((_, i) => (
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div>
            ...
            <button className="inline-flex items-center space-x-3 px-8 py-4 bg-white text-blue-600 rounded-2xl hover:bg-blue-50 transition-all duration-300 transform hover:scale-105 shadow-xl font-semibold">
              <LogIn className="w-5 h-5" />
              <span>Access ERP Portal</span>
            </button>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="border-t border-gray-700 pt-6">
              ...
              <div className="flex justify-center space-x-6 text-sm">
                ...
                <a href="/terms-and-conditions" className="text-gray-400 hover:text-white transition-colors">Terms</a>
                <span className="text-gray-600">|</span>
