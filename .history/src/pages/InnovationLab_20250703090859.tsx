      ...
      <section className="bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            {[
  "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1170&q=80", // People collaborating with laptops
  "https://images.unsplash.com/photo-1581091012184-7f3c1c5d3a3b?auto=format&fit=crop&w=1170&q=80", // Robotics lab
  "https://images.unsplash.com/photo-1612831455546-948b30894280?auto=format&fit=crop&w=1170&q=80", // Team brainstorming
  "https://images.unsplash.com/photo-1581091870623-3f5d68c3baf0?auto=format&fit=crop&w=1170&q=80", // Design thinking workspace
].map((src, idx) => (
  <SwiperSlide key={idx}>
    <img
      src={src}
