    ...
    <main className="pt-20">
      ...
      <section className="bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            {[
             "https://source.unsplash.com/1200x500/?innovation,office",
    "https://source.unsplash.com/1200x500/?teamwork,technology",
    "https://source.unsplash.com/1200x500/?startup,workspace",
    "https://source.unsplash.com/1200x500/?coding,workshop"
            ].map((src, idx) => (
              <SwiperSlide key={idx}>
                <img
                  src={src}
