    ...
    <main className="pt-20">
      ...
      <section className="bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            {[
             "https://images.unsplash.com/photo-1600172454500-8132f4294a8b?auto=format&fit=crop&w=1200&q=80",// Modern lab
              "https://images.unsplash.com/photo-1581091215369-3f4f5f4b3f88?auto=format&fit=crop&w=1200&q=80", // 3D printing
              "https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=1200&q=80", // Robotics
              "https://images.unsplash.com/photo-1581091012184-9ab3c0f3f41d?auto=format&fit=crop&w=1200&q=80" // Teamwork
            ].map((src, idx) => (
              <SwiperSlide key={idx}>
                <img
                  src={src}
