    ...
    <main className="pt-20">
      ...
      <section className="bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            {[
              "https://images.unsplash.com/photo-1581090700227-4c4d50b3c68f?auto=format&fit=crop&w=1200&q=80", // Modern lab
              "https://images.unsplash.com/photo-1610563166152-d67c4a7c367b?auto=format&fit=crop&w=1200&q=80", // 3D printing
              "https://images.unsplash.com/photo-1603898037225-7b8c7e3a5c4b?auto=format&fit=crop&w=1200&q=80", // Robotics
              "https://images.unsplash.com/photo-1555949963-aa79dcee981d?auto=format&fit=crop&w=1200&q=80" // Teamwork
            ].map((src, idx) => (
              <SwiperSlide key={idx}>
                <img
                  src={src}
