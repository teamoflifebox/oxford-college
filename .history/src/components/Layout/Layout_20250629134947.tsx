...
//         <div className="flex-1 pt-16 md:ml-64 transition-all duration-300">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-primary-50/30 to-accent-50/20">
      ...
      <div className="pt-16 flex flex-col md:flex-row">
        {/* Sidebar - appears below navbar and to the left on md+ */}
        <div className="md:w-64 w-full border-b md:border-b-0 md:border-r border-neutral-200">
          <Sidebar isOpen={drawerOpen} onClose={() => setDrawerOpen(false)} />
        </div>
          ...
          <footer className="bg-white/80 backdrop-blur-md border-t border-neutral-200/50 mt-12 shadow-soft">
            <div className="container-custom py-6">
              <div className="text-center">
                ...
                <div className="flex justify-center gap-6 text-sm">
                  <a href="#" className="text-neutral-600 hover:text-primary-600 hover:underline transition-colors">
                    Privacy Policy
                  </a>
                  <span className="text-neutral-400">•</span>
                  <a href="#" className="text-neutral-600 hover:text-primary-600 hover:underline transition-colors">
